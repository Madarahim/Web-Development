...
//images
$images = array("images/lebronvspurs.jpg", "slideshowexample/prom.jpg", "slideshowexample/stevenfall.jpg", "images/astro.jpg", "slideshowexample/gify.gif",
...
<link rel="stylesheet" href="chris_christmascapsule_Body.css">
		...
		<div class="container">
            <div class="row"> 
				<div class="center-block">
					<div>
						<h1 id="titleName">Chris' Christmas Time Capsule</h1>
					</div>
				</div>
				<div class="center-block">
						<div class="row">
							<div class="center-block">
								<div class="well">
									<img src="images/yosemite2.jpg" alt="time capsule" style="width: 430px; height: 240px;" >
									<!-- sentence --> 
									<h1 id="introduction">Room ID: 306723</h1>
									<h4 id = "introductionStatement">Days Until Time Capsule is Closed: 65 days</h4>
					...
					<div class="row">
						<div class="center-block">
							<div class="well">
								...
								<h4 id = "introductionStatement">I love christmas, it is the best time of the year!</h4>
							</div>
						</div>
					</div>
				</div> <!--end info block-->
